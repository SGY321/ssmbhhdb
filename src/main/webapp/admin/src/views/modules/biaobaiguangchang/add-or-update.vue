<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="表白对象" prop="biaobaiduixiang">
          <el-input v-model="ruleForm.biaobaiduixiang" 
              placeholder="表白对象" clearable  :readonly="ro.biaobaiduixiang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="表白对象" prop="biaobaiduixiang">
              <el-input v-model="ruleForm.biaobaiduixiang" 
                placeholder="表白对象" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="表白内容" prop="biaobaineirong">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="表白内容"
                  v-model="ruleForm.biaobaineirong" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.biaobaineirong" label="表白内容" prop="biaobaineirong">
                    <span>{{ruleForm.biaobaineirong}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `biaobaiguangchang/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.biaobaiguangchangCrossAddOrUpdateFlag = false;
                  this.parent.search();
