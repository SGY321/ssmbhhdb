<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="空位置数" prop="kongweizhishu">
          <el-input v-model="ruleForm.kongweizhishu" 
              placeholder="空位置数" clearable  :readonly="ro.kongweizhishu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="空位置数" prop="kongweizhishu">
              <el-input v-model="ruleForm.kongweizhishu" 
                placeholder="空位置数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="人均价格" prop="renjunjiage">
          <el-input v-model="ruleForm.renjunjiage" 
              placeholder="人均价格" clearable  :readonly="ro.renjunjiage"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="人均价格" prop="renjunjiage">
              <el-input v-model="ruleForm.renjunjiage" 
                placeholder="人均价格" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="发起人" prop="faqiren">
          <el-input v-model="ruleForm.faqiren" 
              placeholder="发起人" clearable  :readonly="ro.faqiren"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="发起人" prop="faqiren">
              <el-input v-model="ruleForm.faqiren" 
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.biaoti = true;
          ...
          if(o=='kongweizhishu'){
            this.ruleForm.kongweizhishu = obj[o];
	    this.ro.kongweizhishu = true;
            continue;
          }
          if(o=='chufashijian'){
	    ...
	    this.ro.renjunjiage = true;
          ...
          if(o=='faqiren'){
            this.ruleForm.faqiren = obj[o];
	    this.ro.faqiren = true;
            continue;
          }
          if(o=='lianxifangshi'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `pinchechuxing/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.pinchechuxingCrossAddOrUpdateFlag = false;
                  this.parent.search();
